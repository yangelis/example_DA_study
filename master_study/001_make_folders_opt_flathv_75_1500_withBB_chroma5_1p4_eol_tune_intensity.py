...
array_npart = np.linspace(0.94e11, 1.44e11, 25)
...
for idx_job, (track, qx, n_part) in enumerate(
    itertools.product(track_array, array_qx, array_npart)
):
    ...
    for beam in ["lhcb1", "lhcb2"]:
        ...
        d_config_collider["config_knobs_and_tuning"]["qy"][beam] = float(qx - 62.0 + 60.0 + 5e-3)
        d_config_collider["config_beambeam"]["num_particles_per_bunch"] = float(n_part)
...
# ==================================================================================================
# Define study name
study_name = "opt_flathv_75_1500_withBB_chroma5_1p4_eol_tune_intensity"
